...
| ------------------- | ----------------------------- | ------------- | ------------------------------------------------- |
| Conventional Memory | `0x00000000` ... `0x077FFFFF` | `112 MiB - 1` | Reserved for the guest program                    |
| Hardware MMIO Ports | `0x07800000` ... `0x07FFFFFF` | `8MiB - 1`    | Reserved for the hardware control units' services |
